<div align="center">
<div align="center" class="title">Top PVP's</div>
...
$buscar = mysql_query("SELECT obj_Id, char_name, clanid, pvpkills FROM ".$db.".characters WHERE accesslevel = 0 ORDER BY pvpkills DESC LIMIT 10", $conexao);
  ...
  <tr<?php if($i % 2 == 0){ echo " class='one'"; } else { echo " class='two'"; }?>>
	...
	?></td>
    <td align="Center"><?php echo $dados['pvpkills']; ?></td>
  </tr>
  <?php $i++; }  ?>
</table>
